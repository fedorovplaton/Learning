...
function testingParsing() {
  ...
  let answerCreate = [
    -1, 1, 1, 1, 1, 1, 8, 8, 8, 8, 8, 8, 8, 15, 16, 16, 22, 22, 22, 22, -1
  ];
  ...
  let answerDelete = [
    -1, 1, 1, 1, 1, 7, 7, 7, 7, 7, 7, 7, 14, 15, 15, 21, 21, 21, 21, -1
  ];
  ...
  let commandsShow = [
    ...
    'Покажи почты для контактов, где есть ',
    'Покажи почты для контактов, где есть  ',
    'Покажи почты для контактов, где есть  а',
  ];
  let answerShow = [
  ...
  let commands = commandsDelete;
  let answer = answerDelete;
