...

{
    ...
    lecturer.on('a.b', students.platon, function () {this.v += 1});
    lecturer.on('a.b.c', students.platon, function () {this.v += 1});
    lecturer.off('a.b.d', students.platon);

    lecturer.emit('a.b.c');
    assert.deepEqual(lecturer.print(), [{v:3}]);
}
...

{
    ...
    lecturer.emit('begin');
    assert.deepEqual(getState(students), 'Sam(110,50); Bill(100,55)');
// Sam(110,50); Bill(100,55)
    ...
    lecturer
        ...
        .emit('slide.text')
        .emit('slide.funny');
    assert.deepEqual(getState(students), 'Sam(95,61); Bill(65,63)');
// Sam(95,61); Bill(65,63)
    ...
    lecturer
        ...
        .emit('slide.text')
        .emit('slide.funny');
    assert.deepEqual(getState(students), 'Sam(80,70); Bill(70,53)');
